...
import { getEventsWithActivities, updateActivity, updateItem, createItem, deleteItem, getUserDocId } from "@/lib/firestore";
    ...
    useEffect(() => {
        const fetchItems = async () => {
            ...
            try {
                ...
                const itemsRef = collection(db, "users", userDocId, "events", eventId, "activities", activityId, "items");
