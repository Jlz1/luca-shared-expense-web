                            ...
                            <Toggle
                                ...
                                onChange={async (val) => {
                                    ...
                                    try {
                                        ...
                                        const activityRef = doc(db, "users", String(userDocId), "events", String(eventId), "activities", String(activityId));
                                        ...
                                        if (val === true) {
                                            ...
                                            items.forEach((item) => {
                                                ...
                                                const itemRef = doc(db, "users", String(userDocId), "events", String(eventId), "activities", String(activityId), "items", item.id);
